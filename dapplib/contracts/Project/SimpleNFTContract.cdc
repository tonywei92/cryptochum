import NonFungibleToken from 0x3ebd50faa69303cd
...
pub contract SimpleNFTContract: NonFungibleToken {
    ...
    pub resource NFT: NonFungibleToken.INFT {
        ...
        init(_ipfsHash: String, _action: String) {
            ...
            self.action = _action
            SimpleNFTContract.health = SimpleNFTContract.health + (10 as Int);
            self.health = SimpleNFTContract.health
        }
    }
    ...
    pub resource NFTMinter {
        ...
        pub fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, ipfsHash: String, action: String) {

            // create a new NFT
            var newNFT <- create NFT(_ipfsHash: ipfsHash, _action: action)
